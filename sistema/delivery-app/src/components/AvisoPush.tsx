...
/**
 * Faixa que oferece ligar o aviso de entrega liberada, no aparelho.
 *
      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-xs text-amber-800">
            {mensagem || 'Ligue os avisos para ser chamado quando houver entrega liberada, mesmo com o app fechado.'}
          </p>
          {podeTentar && (
            <button
              type="button"
