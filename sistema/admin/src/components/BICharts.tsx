...
const STATUS_LABELS: Record<string, string> = {
  ...
  READY_FOR_CHECKOUT: 'Aguardando caixa',
  PACKING: 'Embalando',
  PENDING_APPROVAL: 'Aguardando aprovação (B2B)',
...
const STATUS_COLORS: Record<string, string> = {
  ...
  CONFIRMED: '#3B82F6',
  PICKING_PENDING: '#8B5CF6',
  PICKING: '#A855F7',
  WAITING_CUSTOMER_SUBSTITUTION: '#F97316',
  CONFERENCE_PENDING: '#7C3AED',
  PACKING: '#EC4899',
