...
Versao de referencia: 1.24.160-alpha (Apps de Separacao e Entregas integrados)
...
- DTO `UpdateStaffDto` com campos opcionais name, email, role, password.
- Admin API: `staffAPI` com list, create, update, toggleActive.
